...
// 3. Update Staff Grouping renderer
const staffGridRegex = /const renderGrid = \(items: ProductOrderCapacity\[\], title: string, colorClass: string\) => items\.length > 0 && \([\s\S]*?\{products\.length === 0 && <div className="text-center text-gray-400 py-12">No products found<\/div>\}/;
...
// 4. Update Admin Grouping renderer
const adminGridRegex = /const renderGrid = \(items: ProductOrderCapacity\[\], title: string, colorClass: string\) => items\.length > 0 && \([\s\S]*?\{products\.length === 0 && <div className="text-center text-gray-400 py-12">No products found<\/div>\}/;
