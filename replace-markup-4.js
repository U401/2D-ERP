...
const startStr = "{activeTab === 'stock' && !error && (";
const endStr = "{updatingStock && (";
...
fs.writeFileSync(filePath, before + newStockTab + after, 'utf8');
console.log("Successfully replaced only the activeTab === 'stock' section!");
