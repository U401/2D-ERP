-- Update finalize_sale function to support GCash payment method and transaction data
...
BEGIN
  ...
  IF p_payment_method = 'gcash' THEN
    ...
    -- This is a database-level check as a backup to the application-level check
    IF EXISTS (
      SELECT 1 FROM sales 
